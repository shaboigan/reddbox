#!/bin/bash
printf '' > /srv/git/reddbox/ansible-update.log
{
...
} >> /srv/git/reddbox/ansible-update.log 2>&1

returnValue=$?

if [ $returnValue -ne 0 ]; then
    echo "An Error occurred check '/srv/git/reddbox/ansible-update.log' for more information."
fi
