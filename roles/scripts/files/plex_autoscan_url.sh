...
# Config files
readonly SB_ANSIBLE="/srv/git/reddbox/ansible.cfg"
readonly SB_ACCOUNTS="/srv/git/reddbox/accounts.yml"
...
${GREEN}│ URL:               https://github.com/shaboigan/Reddbox                            │
...
function build_url() {
    ...
    # Get variables from Reddbox account settings
